...
export default function Home() {
  ...
  const handleMove = (data: any) => {
    setIdleTimer(0)
   // console.log("handlexy"+data.x+"."+data.y);
    const dbUserRef = ref(database, 'Users/' + userData.userID)
    update(dbUserRef, {
      ismove: 'true',
      moveX: -data.x,
    ...
    return (
      <Container>
        <div className="flex flex-col justify-center items-center gap-5 px-10 h-screen">
          <p className="text-primary-brass text-xl">Anda Telah Meninggalkan Permainan</p>
  ...
  return (
    <div className="min-h-screen max-w-md m-auto">
      <MenuModal
        ...
        isGuest={isAnonymous}
      />
      <div className="bg-dark-red h-3/5 w-full rounded-b-xl relative">
        

        <div className="relative flex justify-center items-center">
          <div className="text-center text-light flex justify-center items-center py-5">
